...
def dglGCN(data, csv_file, epoches, head, num_layers, featuredim, hidden, classes):
    with open("/home/shijinliang/module/tpds/ATT/end2end_break/gat_final/result/dgl.csv", "a") as f:
        f.write(data + ',')  # 追加换行符
...
if __name__ == "__main__":
    ...
    with open(filename, 'w') as file:
        file.write('H100 : \n')
    with open("/home/shijinliang/module/tpds/ATT/end2end_break/gat_final/result/dgl.csv", "w") as f:
        f.write('H100 : \n')
    for head_num in head:
        for layer_num in layer:
            for hidden_num in hidden:
