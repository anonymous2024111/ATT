...
class MGAT_dataset_csr(torch.nn.Module):
    ...
    def __init__(self, data):
        ...
        self.graph = np.load('/home/shijinliang/module/AD/Magicsphere-cmake/dgl_dataset/accuracy/' + data +'.npz')
    ...
    def init_edges(self):
        ...
        self.degrees_trans, \
        self.window, \
        self.automic = ATT_Block.blockProcess_sddmm_balance_gnn_trans(row, col, 8, 8, partize)
    ...
    def init_embedding(self):
        ...
        # self.x = self.x.unsqueeze(0).expand(2, -1, -1)
    ...
    def init_others(self):
        ...
        self.ones1 = torch.ones(size=(self.num_nodes_ori,1,2), dtype=torch.float16)
    def to(self, device):
        ...
        self.ones1 =  self.ones1.to(device)
        return self
