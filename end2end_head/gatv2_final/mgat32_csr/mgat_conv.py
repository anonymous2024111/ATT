...
class MGATFunction_multi(torch.autograd.Function):
    ...
    def forward(ctx, X_prime0, X_prime1, a0, inputInfo):
        ...
        att = ATT_SDDMM_v3.attv2_tf32_h_nnz(
    ...
    def backward(ctx, att_grad):
        ...
        求a0梯度
        '''
        a0_right = ATT_SpMM_v3.spmm_tf32_h_m_rowsum(
            inputInfo.row_pointers,
        ...
        a0_left = ATT_SpMM_v3.spmm_tf32_h_m_rowsum(
            inputInfo.row_pointers,
            inputInfo.degrees, 
            att_grad,
            inputInfo.window,
...
class MGATSpmm_multi(torch.autograd.Function):
    ...
    def forward(ctx, att, X_prime, inputInfo):
        ...
        X_prime= ATT_SpMM_v3.spmm_tf32_m_h(
            inputInfo.row_pointers,
            inputInfo.column_index, 
            inputInfo.degrees, 
            att,
    ...
    def backward(ctx, X_prime_grad):
        ...
        d_X_prime= ATT_SpMM_v3.spmm_tf32_h_m(
            inputInfo.row_pointers,
            inputInfo.column_index, 
            inputInfo.degrees_trans, 
            att,
        ...
        d_att = ATT_SDDMM_v3.sddmm_tf32_h_nnz(
            inputInfo.row_pointers, 
            inputInfo.column_index,
            inputInfo.degrees, 
            inputInfo.window,
...
class MGATSpmm1_multi(torch.autograd.Function):
    ...
    def forward(ctx, att, inputInfo):
        ...
        X_prime= ATT_SpMM_v3.spmm_tf32_m_h_rowsum(
            inputInfo.row_pointers,
            inputInfo.degrees, 
            att,
            inputInfo.window,
    ...
    def backward(ctx, X_prime_grad):
        ...
        d_att = ATT_SDDMM_v3.sddmm_tf32_ones_h_nnz(
            inputInfo.row_pointers, 
            inputInfo.column_index,
            inputInfo.degrees, 
            inputInfo.window,
