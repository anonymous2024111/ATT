...
class MGAT_dataset_csr(torch.nn.Module):
    ...
    def init_edges(self):
        ...
        dd= torch.rsqrt(self.dd1) 

        self.dd1=self.dd1[:self.num_nodes_ori].reshape(-1, 1) 
        
        self.row_pointers, \
        self.column_index, \
        self.degrees, \
        self.t_window_rowTensor, \
        self.t_atomicTensor = Block_sr_bcrs.blockProcess_tf32_balance(self.row_pointers, self.column_index, dd, 8, 4, 32)
