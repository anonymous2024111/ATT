...
for data in dataset:
    ...
    df_att = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end/gatv2_no_pre_multi/resulta800/gat16/gat16_new_'+ data + '.csv')
    for index, row in df_att.iterrows():
        gat16.append(row['time'])
        
    df_pyg = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end/gatv2_no_pre_multi/resulta800/pyg/pyg_'+ data + '.csv')
...
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end/plot/end2end-GATv2/a800—pyg.png', dpi=800)
