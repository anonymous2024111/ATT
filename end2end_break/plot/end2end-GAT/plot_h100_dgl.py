...
#读取dgl的数据
df_dgl = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/dgl-v2.csv')
df_att_fp16 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/mgcn16-v2.csv')
df_att_tf32 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/mgcn32-v2.csv')
df_pyg = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/pyg-v2.csv')
...
pyg_avg = np.mean([pyg_sp_64, pyg_sp_64], axis=0)

ind = np.arange(len(gat16_sp_64)) * 1.8  # 每个索引间隔变大
width = 0.4  # 保证宽度不会过大或过小
# 绘制柱状图
...
# 第一组柱状图
bar1 = ax.bar(ind - width, pyg_avg, width, label='PyG', color=colors[0], edgecolor='black', linewidth=1.5, zorder=2)
...
# 第三组柱状图
bar3 = ax.bar(ind + width, gat16_avg, width, label='TCGAT-FP16', color=colors[2], edgecolor='black', linewidth=1.5, zorder=2)
...
# 保存图像
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_ori/plot/end2end-GAT/1h100.png', dpi=800)
