...
class GATConv_multi(torch.nn.Module):
    ...
    def forward(self, X, inputInfo):
        ...
        print("Linear time: ", execution_time*1000)
        ...
        end_time = time.time()
        execution_time = end_time - start_time
        print("Attention time: ", execution_time*1000)
        ...
        end_time = time.time()
        execution_time = end_time - start_time
        print("Aggregate time: ", execution_time*1000)
        ...
        end_time = time.time()
        softmax += end_time - start_time
        print("Softmax time: ", softmax*1000)
