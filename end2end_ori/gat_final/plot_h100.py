...
# # 第四组柱状图
# bar4 = ax.bar(ind + width * 2, pyg_avg, width, label='DGL', color=colors[3], edgecolor='black', linewidth=1.5, zorder=2)
...
# 保存图像
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/h100-gat.png', dpi=800)
