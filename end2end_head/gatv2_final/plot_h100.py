...
#读取dgl的数据
df_dgl = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_head/gatv2_final/result/dgl.csv')
df_att_fp16 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_head/gatv2_final/result/mgat16.csv')
df_att_tf32 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_head/gatv2_final/result/mgat32.csv')
...
for dataset in datasets:
    ...
    plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_head/gatv2_final/plot/' + dataset + '.png', dpi=800)
