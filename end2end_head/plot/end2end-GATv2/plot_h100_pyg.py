...
for data in dataset:
    ...
    pyg = []
    #读取dgl的数据
    df_att = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end/gatv2_no_pre_multi/result/gat16/gat16_new_'+ data + '.csv')
    for index, row in df_att.iterrows():
        gat16.append(row['time'])
        
    df_pyg = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end/gatv2_no_pre_multi/result/pyg/pyg_'+ data + '.csv')
...
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end/plot/end2end-GATv2/h100—pyg.png', dpi=800)
