...
#读取dgl的数据
df_dgl = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gatv2_final/result/dgl.csv')
df_att_fp16 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gatv2_final/result/mgat16.csv')
df_att_tf32 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gatv2_final/result/mgat32.csv')
df_pyg = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gatv2_final/result/pyg.csv')
...
# 提取数据集名称
datasets = []
filter= ['reddit', 'AmazonProducts', 'IGB_medium', 'ogbn-proteins', 'ogb']
filter= ['AmazonProducts', 'IGB_medium']
gat16_sp_64_time = []
for index, row in temp.iterrows():
    if row['config'] == '3-64':
        if row['data'] not in filter:
            ...
            gat16_sp_64_time.append(row['gat16'])
            gat16_sp_64.append(0) 
            gat32_sp_64.append(0)
            pyg_sp_64.append(0) 
    ...
    if row['config'] == '3-128':
        if row['data'] not in filter:
            ...
            gat16_sp_128.append(0) 
            gat32_sp_128.append(0)
            pyg_sp_128.append(0) 
...
# 保存图像
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_ori/gatv2_final/h100-gatv2.png', dpi=800)
