...
# 读取 CSV 文件（确保文件路径正确）
dgl = pd.read_csv("/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/dgl.csv")
pyg = pd.read_csv("/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/pyg.csv")
mgat16 = pd.read_csv("/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/mgat16.csv")
mgat32 = pd.read_csv("/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/mgat32.csv")
...
# 显示图形
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/gatv2_att.png', dpi=800)
plt.close()
...
ax1.get_xaxis().set_visible(False)
# 显示图形
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end_break/gatv2_final/result/gatv2_spmm.png', dpi=800)
