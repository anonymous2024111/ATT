...
for data in dataset:
    ...
    pyg = []
    #读取dgl的数据
    df_dgl = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end/gatv2_no_pre_multi/result/dgl/dgl_'+ data + '.csv')
...
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end/plot/end2endGATv2/h100—dgl.png', dpi=800)
