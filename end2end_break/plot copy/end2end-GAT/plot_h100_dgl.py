...
for data in dataset:
    ...
    df_att_fp16 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/mgc16-v2.csv')
    for index, row in df_att_fp16.iterrows():
        gat16.append(row['time'])

    df_att_tf32 = pd.read_csv('/home/shijinliang/module/tpds/ATT/end2end_ori/gat_final/result/mgc32-v2.csv')
    for index, row in df_att_tf32.iterrows():
        gat32.append(row['time'])
...
plt.savefig('/home/shijinliang/module/tpds/ATT/end2end/plot/end2end/h100—dgl.png', dpi=800)
