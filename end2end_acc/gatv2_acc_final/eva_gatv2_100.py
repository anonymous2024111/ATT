...
import csv
import sys
sys.path.append('./eva100/end2end/gatv2_acc_final')
import os
...
if __name__ == "__main__":
    ...
    dataset = [ 'cora', 'pubmed', 'question', 'min']
    epoches = 300
    layer = 3
    hidden = 128
    ...
    # #DGL
    # filename = '/home/shijinliang/module/tpds/ATT/end2end/gatv2_acc_final/result/dgl-acc.csv'
    ...
    # MGCN-fp16
    filename = '/home/shijinliang/module/tpds/ATT/end2end/gatv2_acc_final/result/mgcn16-acc.csv'
    # with open(filename, 'w') as file:
    ...
    # # # #MGCN-tf32   
    # filename = '/home/shijinliang/module/tpds/ATT/end2end/gatv2_acc_final/result/mgcn32-acc.csv'
    # with open(filename, 'w') as file:
    ...
    # # #PYG
    # filename = '/home/shijinliang/module/tpds/ATT/end2end/gatv2_acc_final/result/pyg-acc.csv'
    # with open(filename, 'w') as file:
